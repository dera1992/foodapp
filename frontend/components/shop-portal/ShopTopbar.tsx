...
export function ShopTopbar({ title = 'Shop Portal', shopName = 'My Shop', initials = 'SH', onToggleSidebar }: {
  title?: string;
  shopName?: string;
  initials?: string;
          ...
          {dropdownOpen && (
            <div className="bf-account-dropdown absolute right-0 top-full z-50 mt-1 w-56" role="menu">
              <div className="bf-dd-head">
                ...
                <div className="bf-dd-role"><div className="bf-dd-role-dot" />Shop Owner</div>
              </div>
